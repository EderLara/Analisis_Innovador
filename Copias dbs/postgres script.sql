...
-- Formas de Pago (tipo_pago)
INSERT INTO tipo_pago (nombre) VALUES
('Efectivo'), ('Tarjeta'), ('Transferencia');

-- Vendedores (promotor)
INSERT INTO promotor (nombre, cargo) VALUES
('Elena Marín', 'Asesor de Servicio al Cliente'),
('Miguel Torres', 'Especialista en Preventa'),
('Sofía Vidal', 'Jefa de Equipo de Ventas'),
('Andrés Herrera', 'Representante de Ventas Internas'),
('Patricia Díaz', 'Asesor Comercial B2B'),
('David Romero', 'Gerente Regional'),
('Isabel Núñez', 'Consultor Senior de Implementación'),
('Felipe Lira', 'Asociado de Desarrollo de Negocios'),
('Mónica Reyes', 'Analista de Soporte a Ventas'),
('Jorge Ponce', 'Coordinador de Marketing y Ventas');
...
-- Movimientos (movimiento) - 10,000 registros aleatorios
INSERT INTO movimiento (
  fecha, item_id, persona_id, promotor_id, almacen_id, tipo_pago_id, cantidad, total
)
SELECT
  -- Genera una fecha aleatoria en un rango de 2450 días
